...
throw new Exception("Đây là một lỗi mô phỏng cho mục đích ghilog.");
}
catch (Exception ex)
{
// Ghi log lỗi (mức Error) bao gồm cả thông tin chi tiết về
ngoại lệ
_logger.LogError(ex, "Một ngoại lệ chưa được xử lý đã xảy ra
trong hành động ErrorExample.");
}
