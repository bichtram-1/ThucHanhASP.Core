...
new Product { ProductID = 4, Name = "Giày chạy bộ Nike Air",Description = "Giày êm ái, hỗ trợ tối đa cho các buổi tập dài.", Price =
95.00m, Category = "Giày" },
new Product { ProductID = 5, Name = "Bóng chuyền Mikasa
MVA200", Description = "Bóng chuyền tiêu chuẩn thi đấu quốc tế.", Price =
